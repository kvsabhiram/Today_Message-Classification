...
# ---------------------------------------------------------------------------
# Security group — app port (+ optional SSH)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# GitHub Actions OIDC role (keyless CI auth)
# ---------------------------------------------------------------------------
...
# Read-only role for `terraform plan` on pull requests. PRs run under the OIDC
# subject `repo:<owner>/<repo>:pull_request`, which the deploy role above does NOT
# trust — so plan gets its own role with only read access.
...
# ReadOnlyAccess lets `plan` describe resources and read the S3 state object.
